/*
 * A tiny implementation of Shabal.
 *
 * This is the common header file for various implementations of the
 * Shabal family of hash functions, optimized for compactness. The
 * implementations are written in assembly for a number of
 * architectures; two generic portable C implementations are also
 * provided.
 *

/*
 * Implementation of Shabal: portable code with low RAM.
 *
 * Instead of using a temporary Bx[] buffer for intermediate B-word
 * values, this code stores those values in the context structure. This
 * saves about 256 bytes of RAM, but implies slightly larger and slower
 * code.
 *
 * -----------------------------------------------------------------------

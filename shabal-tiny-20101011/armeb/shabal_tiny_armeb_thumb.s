@ Implementation of Shabal: ARM, big-endian, Thumb-only.
@
...
@ -----------------------------------------------------------------------
	...
	.code   16
	.file   "shabal_tiny_armeb_thumb.s"
	.text

@ byteswap(bb)
@    bb   pointer to a 64-byte buffer
@
@ This function expects its argument in v1, not a1. Registers a1, a2 and a4
@ may be modified. It byteswaps in place the 16 words at the specified
